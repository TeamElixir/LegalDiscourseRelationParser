...
public class SQLiteUtils {
	...
	public SQLiteUtils() throws SQLException {
		if(connection==null){
			connection = DriverManager.getConnection("jdbc:sqlite:/media/gathika/Other/repos/LegalDisourseRelationParser/sentence-feature-extractor/extractorDatabase.db");
		}
	}
