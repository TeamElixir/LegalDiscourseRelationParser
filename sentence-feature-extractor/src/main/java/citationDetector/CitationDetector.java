...
public class CitationDetector {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedWriter bw_arg = new BufferedWriter(new FileWriter(new File("G:\\repos\\ldrp\\LegalDisourseRelationParser\\sentence-feature-extractor\\src\\main\\resources\\Cases\\Lee_argument.txt")));
        BufferedWriter bw_non_arg = new BufferedWriter(new FileWriter(new File("G:\\repos\\ldrp\\LegalDisourseRelationParser\\sentence-feature-extractor\\src\\main\\resources\\Cases\\jaeLee_non_arg.txt")));
